...
<head>
  ...
  <body>
<script th:fragment="messagebird_plugin">
		var MessageBirdChatWidgetSettings = {
			widgetId : 'd951a344-b5a0-4ec8-8758-176a4aaa5cfd',
		...
		!function() {
			...
			if (Boolean(document.getElementById("live-chat-widget-script")))
				...
				for (var i = [ "init", "setConfig", "toggleChat", "identify",
						"hide", "on", "shutdown" ], n = function() {
					var e = i[d];
					...
					n();
				var a = (null === (e = window) || void 0 === e
						|| null === (t = e.MessageBirdChatWidgetSettings)
						|| void 0 === t ? void 0 : t.widgetId)
						|| "", o = function() {
					var e, t = document.createElement("script");
							t.type = "text/javascript",
							t.src = "https://livechat.messagebird.com/bootstrap.js?widgetId="
									.concat(a), t.async = !0,
							t.id = "live-chat-widget-script";
					var i = document.getElementsByTagName("script")[0];
					null == i || null === (e = i.parentNode) || void 0 === e
							|| e.insertBefore(t, i)
				};
